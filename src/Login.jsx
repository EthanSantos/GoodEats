...
const Login = ({ errorMsg, setErrorMsg, handleLoginSuccess, setUserId, display, setDisplay }) => {
            ...
            <ThemeProvider theme={theme}>
                ...
                <div style={{ width: '35%', margin: '10% auto', backgroundColor: '#FFFFFF', borderRadius: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)' }}>
                    <>
                        ...
                        <p style={{ textAlign: 'center', paddingBottom: '50px' }}>Don't have an account? <a href="/#"
                            onClick={handleClick}>Sign up</a></p>
                    </>
                </div>
            </ThemeProvider>
        </div>
